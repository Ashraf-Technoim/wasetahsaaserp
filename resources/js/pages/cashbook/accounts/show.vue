        ...
        <div class="invoice p-3 mb-3">
          ...
          <div class="row invoice-info">
            ...
            >
              ...
              {{ allData.bankName }}<br />
              <span v-if="allData.branchName"
                ><strong>{{ $t("cashbook.common.branch_name") }}:</strong>
                {{ allData.branchName }}<br
              /></span>
              <span v-if="allData.accountNumber"
                ><strong>{{ $t("cashbook.common.account_number") }}:</strong>
                {{ allData.accountNumber }}<br
              /></span>
              <span v-if="allData.accountNumber"
              ...
              <div>
                <div class="row no-print pt-3 px-3">
                  ...
                  <div
                    ...
                    class="col-xl-10 col-md-9 col-8 text-right"
                  >
                    <a
                      :href="'/account-transactions/pdf/' + allData.slug"

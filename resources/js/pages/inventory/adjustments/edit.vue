                  ...
                  <table class="table table-sm">
                    ...
                    <tbody>
                      <tr v-for="(item, i) in form.selectedProducts" :key="i">
                        ...
                        <td>
                          <select class="form-control w-200px"
                            @change="updateProduct($event.target.value, 'adjustType', i - 1)" :id="`adjustType-${i}`"
                            required>
                        ...
                        <td>
                          <div class="input-group custom-qty-input">
                            ...
                            <input type="number" step="any" :id="`Qty-${i}`" name="quantity"
                              ...
                              @change="updateProduct($event.target.value, 'quantity', i - 1)"
    ...
    updateProduct(value, type, index) {
      ...
      if (selectedProduct) {
        if (type == 'quantity' && selectedProduct.adjustQty >= 1) {
          selectedProduct.adjustQty = Number(value)

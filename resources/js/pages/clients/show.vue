              ...
              <div class="col-md-11">
                <ul class="nav nav-pills">
                  <li v-if="$can('invoice-list')" class="nav-item">
                    <a class="nav-link active" href="#invoices" data-toggle="tab">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 col-md-2 text-right mb-2">
                        <div class="btn-group c-w-100">
                          <a @click="refreshTable('invoice')" href="#" v-tooltip="'Refresh'" class="btn btn-success">
                ...
                <div>
                  <div class="card-body p-0 position-relative">
                    <div class="row">
                      ...
                      <div class="col-12 col-md-2 text-right mb-2">
                        <div class="btn-group c-w-100">
                          <a @click="refreshTable('invoice-returns')" href="#" v-tooltip="'Refresh'"
                ...
                <div>
                  <div class="card-body p-0 position-relative">
                    <div class="row">
                      ...
                      <div class="col-12 col-md-2 text-right mb-2">
                        <div class="btn-group c-w-100">
                          <a @click="refreshTable('invoice-payments')" href="#" v-tooltip="'Refresh'"
                            class="btn btn-success">
                            <i class="fas fa-sync"></i>
                          </a>
                        </div>
                  ...
                  <!-- NEW PAGINATION -->
                  <div v-if="paymentPagination && paymentPagination.total > 0" class="dtable-footer">
                    <div class="form-group row display-per-page">
                      <label>{{ $t("per_page") }} </label>
                      <div>
                ...
                <div>
                  <div class="card-body p-0 position-relative">
                    <div class="row">
                      ...
                      <div class="col-12 col-md-2 text-right mb-2">
                        <div class="btn-group c-w-100">
                          <a @click="refreshTable('non-invoice-transactions')" href="#" v-tooltip="'Refresh'"
                            class="btn btn-success">
                            <i class="fas fa-sync"></i>
                          </a>
                        </div>
...
export default {
  ...
  methods: {
    ...
    async getClient() {
      ...
      this.allData.image = data.data.image ? '/' + data.data.image : ''
    },

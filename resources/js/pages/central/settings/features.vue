        ...
        >
          ...
          <div class="form-group row">
            <label
              ...
              class="col-sm-2 col-form-label text-md-right text-left"
            >
            ...
            <div class="col-sm-10">
              <input
                ...
                class="form-control"
                :class="{
                  'is-invalid': form.errors.has('features_section_tagline'),
                }"
                id="features_section_tagline"
                :placeholder="$t('common.features_section_tagline_placeholder')"
              />
              <has-error :form="form" field="features_section_tagline" />
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input
                ...
                class="form-control"
                :class="{
                  'is-invalid': form.errors.has('features_section_title'),
                }"
                id="features_section_title"
                :placeholder="$t('common.features_section_title_placeholder')"
              />
              <has-error :form="form" field="features_section_title" />
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <textarea
                ...
                class="form-control"
                :class="{
                  'is-invalid': form.errors.has('features_section_description'),
                }"
                id="features_section_description"
                :placeholder="
                  $t('common.features_section_description_placeholder')
                "
              >
              </textarea>
              <has-error :form="form" field="features_section_description" />
            </div>
          </div>
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th>{{ $t("central.setting_images.title") }}</th>
        ...
        >
          ...
          <div class="form-group col-md-6">
            ...
            <input
              ...
              type="text"
              class="form-control"
              :class="{ 'is-invalid': dataForm.errors.has('title') }"
              name="title"
              :placeholder="$t('title')"
            />
          ...
          <div class="form-group col-md-12">
            ...
            <div class="custom-file">
              <input
                ...
                name="image"
                :class="{ 'is-invalid': dataForm.errors.has('image') }"
                @change="onFileChange"
              />
          ...
          <div class="form-group col-md-12">
            ...
            <textarea
              ...
              class="form-control"
              :class="{ 'is-invalid': dataForm.errors.has('description') }"
              name="description"
              :placeholder="
                $t('central.setting_images.description_placeholder')
              "
            />
...
export default {
  ...
  methods: {
    ...
    async update() {
      await this.form
        .patch(window.location.origin + "/api/settings/features-settings")
        .then(() => {
          toast.fire({
            type: "success",

      ...
      <div class="card-body">
        ...
        >
          ...
          <div class="form-group row">
            ...
            >
              {{ $t("common.why_us_tagline") }} <span class="required">*</span>
            </label>
            <div class="col-sm-10">
              <input
                type="text"
                ...
                class="form-control"
                :class="{ 'is-invalid': form.errors.has('why_us_tagline') }"
                id="why_us_tagline"
                :placeholder="$t('common.why_us_tagline_placeholder')"
              />
          ...
          <div class="form-group row">
            <label
              ...
              class="col-sm-2 col-form-label text-md-right text-left"
            >
              {{ $t("common.why_us_title") }} <span class="required">*</span>
            </label>
            <div class="col-sm-10">
              <input
                type="text"
                ...
                class="form-control"
                :class="{ 'is-invalid': form.errors.has('why_us_title') }"
                id="why_us_title"
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <textarea
                ...
                class="form-control"
                :class="{ 'is-invalid': form.errors.has('why_us_description') }"
                id="why_us_description"
                :placeholder="$t('common.why_us_description_placeholder')"
              ></textarea>
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th>{{ $t("central.setting_images.description") }}</th>

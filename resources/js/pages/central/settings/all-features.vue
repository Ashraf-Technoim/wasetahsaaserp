          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input
                ...
                class="form-control"
                :class="{
                  'is-invalid': form.errors.has('all_features_section_tagline'),
                }"
                id="all_features_section_tagline"
                :placeholder="
                  $t('common.all_features_section_tagline_placeholder')
                "
              />
              <has-error :form="form" field="all_features_section_tagline" />
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input
                ...
                class="form-control"
                :class="{
                  'is-invalid': form.errors.has('all_features_section_title'),
                }"
                id="all_features_section_title"
                :placeholder="
                  $t('common.all_features_section_title_placeholder')
                "
              />
              <has-error :form="form" field="all_features_section_title" />
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    async update() {
      await this.form
        .patch(window.location.origin + "/api/settings/all-features-settings")
        .then(() => {
          toast.fire({
            type: "success",

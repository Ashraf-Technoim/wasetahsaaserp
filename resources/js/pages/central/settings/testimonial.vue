          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input
                ...
                class="form-control"
                :class="{
                  'is-invalid': form.errors.has('testimonial_section_tagline'),
                }"
                id="testimonial_section_tagline"
                :placeholder="
                  $t('common.testimonial_section_tagline_placeholder')
                "
              />
              <has-error :form="form" field="testimonial_section_tagline" />
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input
                ...
                class="form-control"
                :class="{
                  'is-invalid': form.errors.has('testimonial_section_title'),
                }"
                id="testimonial_section_title"
                :placeholder="
                  $t('common.testimonial_section_title_placeholder')
                "
              />
              <has-error :form="form" field="testimonial_section_title" />
            </div>
          </div>
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th>{{ $t("central.setting_images.name") }}</th>
        ...
        >
          ...
          <div class="form-group col-md-12">
            ...
            <input
              ...
              type="text"
              class="form-control"
              :class="{ 'is-invalid': dataForm.errors.has('name') }"
              name="name"
              :placeholder="$t('name')"
            />
...
export default {
  ...
  methods: {
    ...
    async update() {
      await this.form
        .patch(window.location.origin + "/api/settings/testimonial-settings")
        .then(() => {
          toast.fire({
            type: "success",

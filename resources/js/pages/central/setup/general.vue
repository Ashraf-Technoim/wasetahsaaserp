        ...
        <div class="card">
          ...
          <form role="form" @submit.prevent="updateSettings" @keydown="form.onKeydown($event)">
            <div class="card-body">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input id="companyName" v-model="form.companyName" type="text" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('name') }" name="companyName"
                ...
                <div class="form-group col-md-6">
                  <label for="companyTagline">{{
                      $t(
                        'central.setup.general_settings.index.company_info.company_tagline'
                      )
                  }}
                    <span class="required">*</span></label>
                  <input id="companyTagline" v-model="form.companyTagline" type="text" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('companyTagline') }" name="companyTagline" :placeholder="
                      $t(
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input id="emailAddress" v-model="form.emailAddress" type="email" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('emailAddress') }" name="emailAddress" :placeholder="
                      $t(
                ...
                <div class="form-group col-md-6">
                  ...
                  <input id="phoneNumber" v-model="form.phoneNumber" type="text" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('phoneNumber') }" name="phoneNumber" :placeholder="
                      $t(
              ...
              <strong>{{
                  $t(
                    'central.setup.general_settings.index.default_elements.default_elements_title'
                  )
              }}</strong>
              <hr />
              <div class="row">
                <div class="form-group col-md-6">
                  <label for="language">{{
                      $t(
                        'central.setup.general_settings.index.default_elements.default_language'
                      )
                  }}
                    <span class="required">*</span></label>
                  <select v-model="form.language" name="" class="form-control"
                    ...
                    <option value="en">
                      {{
                          $t(
                            'central.setup.general_settings.index.default_elements.english_en'
                          )
                      }}
                    </option>
                    <option value="hi">
                      {{
                          $t(
                            'central.setup.general_settings.index.default_elements.hindi_hi'
                          )
                      }}
                    </option>
                  </select>
                ...
                <div class="form-group col-md-6">
                  <label for="copyrightText">{{
                      $t(
                        'central.setup.general_settings.index.default_elements.copyright_text'
                      )
                  }}
                    <span class="required">*</span></label>
                  <input id="copyrightText" v-model="form.copyrightText" type="text" class="form-control"
                    ...
                    placeholder="$t('central.setup.general_settings.index.default_elements.copyright_text_placeholder')" />
                ...
                <div class="form-group col-md-6">
                  <label for="facebook_link">{{
                      $t(
                        'central.setup.general_settings.index.default_elements.facebook_link'
                      )
                  }}</label>
                  <input id="facebook_link" v-model="form.facebook_link" type="url" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('facebook_link') }" name="facebook_link"
                    placeholder="$t('central.setup.general_settings.index.default_elements.facebook_link_placeholder')" />
                  <has-error :form="form" field="facebook_link" />
                </div>

                <div class="form-group col-md-6">
                  <label for="instagram_link">{{
                      $t(
                        'central.setup.general_settings.index.default_elements.instagram_link'
                      )
                  }}</label>
                  <input id="instagram_link" v-model="form.instagram_link" type="url" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('instagram_link') }" name="instagram_link"
                    placeholder="$t('central.setup.general_settings.index.default_elements.instagram_link_placeholder')" />
                  <has-error :form="form" field="instagram_link" />
                </div>

                <div class="form-group col-md-6">
                  <label for="twitter_link">{{
                      $t(
                        'central.setup.general_settings.index.default_elements.twitter_link'
                      )
                  }}</label>
                  <input id="twitter_link" v-model="form.twitter_link" type="url" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('twitter_link') }" name="twitter_link"
                    placeholder="$t('central.setup.general_settings.index.default_elements.twitter_link_placeholder')" />
                  <has-error :form="form" field="twitter_link" />
                </div>

                <div class="form-group col-md-6">
                  <label for="linkedin_link">{{
                      $t(
                        'central.setup.general_settings.index.default_elements.linkedin_link'
                      )
                  }}</label>
                  <input id="linkedin_link" v-model="form.linkedin_link" type="url" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('linkedin_link') }" name="linkedin_link"
                    placeholder="$t('central.setup.general_settings.index.default_elements.linkedin_link_placeholder')" />
                  <has-error :form="form" field="linkedin_link" />
                </div>
              </div>
              <div class="row">
                <div class="form-group col-md-6">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  <label for="trial_day_count">
                    {{ $t('central.setup.general_settings.index.company_info.trial_day_count') }}
                    <span class="required">*</span></label>
                  <input id="trial_day_count" v-model="form.trial_day_count" type="number" min="0" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('trial_day_count') }" name="trial_day_count"
                    :placeholder="$t('setup.general_settings.index.trial_day_count_placeholder')" />
                  <has-error :form="form" field="trial_day_count" />
                </div>
              </div>
            </div>
            <!-- /.card-body -->

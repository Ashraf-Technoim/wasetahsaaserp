      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">{{ $t('setup.brands.edit.form_title') }}</h3>
          ...
          <!-- form start -->
          <form role="form" enctype="multipart/form-data" @submit.prevent="updateBrand"
...
export default {
  ...
  methods: {
    ...
    async getBrand() {
      ...
      this.url = data.data.image ? '/' + data.data.image : null
    },

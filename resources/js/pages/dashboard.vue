<template>
  <div>
    ...
    <div class="container-fluid">
      ...
      <div
        v-if="$can('payment-sent-vs-payment-received') || $can('top-clients')"
        class="row"
      >
        <div
          v-if="
            ...
            <div class="card-header">
              <h3 class="card-title">
                ...
                <a
                  ...
                  v-tooltip="$t('dashboard.line_chart_tooltip')"
                >
        ...
        <div
          ...
          class="col-md-12"
          :class="
            $can('payment-sent-vs-payment-received') ? 'col-lg-4' : 'col-lg-12'
          "
        >
          <TopClients />
        </div>
            ...
            <div class="card-header">
              <h3 class="card-title">
                ...
                <a
                  href="#"
                  class="badge badge-info ml-2"
                  v-tooltip="$t('dashboard.bar_chart_tooltip')"
                >
                  <i class="fas fa-info"></i>
                </a>
              </h3>

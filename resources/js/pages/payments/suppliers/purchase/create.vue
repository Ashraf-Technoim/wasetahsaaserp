              ...
              <div class="row" v-if="items">
                <div class="form-group col-md-12">
                  ...
                  <v-select v-model="form.supplier" :options="items" label="name"
                    ...
                    placeholder="Select a supplier" @input="getPurchases" />
              ...
              <div class="row mb-3" v-if="form.supplier && purchases">
                <div class="form-group col-md-12">
                  ...
                  <v-select v-model="form.purchase" :options="purchases" label="purchaseNo"
                    :class="{ 'is-invalid': form.errors.has('purchase') }" name="purchase" :placeholder="
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <input type="text" :id="`purchaseDue-${i}`" class="form-control" :value="item.newDue"
                          readonly />
                      </div>
                      <div class="form-group col-md-3">

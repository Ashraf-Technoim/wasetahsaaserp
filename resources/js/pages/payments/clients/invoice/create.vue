              ...
              <div class="row" v-if="items">
                <div class="form-group col-md-12">
                  ...
                  <v-select v-model="form.client" :options="items" label="name"
                    ...
                    :placeholder="$t('common.client_placeholder')" @input="getInnvoices" />
              ...
              <div class="row mb-3" v-if="form.client && invoices">
                <div class="form-group col-md-12">
                  ...
                  <v-select v-model="form.invoice" :options="invoices" label="label"
                    :class="{ 'is-invalid': form.errors.has('invoice') }" name="invoice" :placeholder="
...
export default {
  ...
  methods: {
    ...
    updateArray(value, index) {
      let invocie = this.form.selectedInvoices[index]
      if (invocie && value <= invocie.maxAmount) {
        this.form.selectedInvoices[index].paidAmount = Number(value)
        invocie.newDue = Number(
          (invocie.originalDue - invocie.paidAmount).toFixed(2)
        )
      }

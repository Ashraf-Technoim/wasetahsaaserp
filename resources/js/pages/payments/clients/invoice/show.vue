              ...
              <div class="table-responsive table-custom">
                <table class="table">
                  ...
                  <tbody v-if="allData.invoice">
                    <tr>
                      <td>{{ allData.invoice.invoiceNo | withPrefix(invoicePrefix) }}</td>
                      <td>{{ allData.invoice.invoiceDate | moment('Do MMM, YYYY') }}</td>
                      <td>{{ allData.invoice.invoiceTotal | withCurrency }}</td>
                      <td>{{ allData.amount | withCurrency }}</td>
                      <td>
                        <span v-if="allData.account">{{ allData.account.label }}</span>
                      </td>
                      <td class="text-right">
                        <span v-if="allData.date">{{ allData.date | moment('Do MMM, YYYY') }}</span>
                      </td>
                    </tr>
                  </tbody>
                </table>

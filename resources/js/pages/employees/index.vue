      ...
      <div class="col-lg-12">
        <div>
          <div class="row">
            ...
            <div class="col-12 col-md-6 col-xl-4 mb-2">
              <date-range-picker ref="picker" opens="center" :locale-data="locale" :minDate="minDate" :maxDate="maxDate"
            ...
            <div class="col-12 col-md-12 col-xl-4 text-right mb-2">
              <div class="btn-group c-w-100">
                ...
                <a href="/employees/pdf" v-tooltip="$t('common.export_table')" class="btn btn-secondary">
                ...
                <router-link v-if="
                  $can('employee-create') &&
                  tenant.plan.limit_employees === 0 || pagination && tenant.plan.limit_employees > pagination.total
                " :to="{ name: 'employees.create' }" class="btn btn-primary">
                  {{ $t('common.create') }}

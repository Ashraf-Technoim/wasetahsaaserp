          ...
          <div class="col-md-12">
            ...
            <div class="alert alert-info">
              ...
              <ul>
                ...
                <li>
                  {{
                    $t(
                      "Populate the products\.csv with your product information"
                    )
                  }}
                </li>
                <li>
                  {{
                    $t(
                      "You can get the ids related to product to their corresponding CSV file"
                    )
                  }}
                </li>
            ...
            <div class="form-group">
              <a @click="downloadTemplate" class="btn btn-primary">
                <i class="fas fa-download"></i> {{ $t("Download Template") }}
              </a>
            </div>
          </div>
        </div>

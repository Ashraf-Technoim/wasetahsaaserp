              ...
              <div class="row">
                ...
                <div class="form-group col-md-6 col-xl-3">
                  <div class="input-group">
                    ...
                    <input v-model="form.itemCode" type="number" class="form-control"
                ...
                <div class="form-group col-md-6 col-xl-4">
                  <div class="input-group">
                    ...
                    <input v-model="form.discount" type="number" min="0" max="99" class="form-control"
                ...
                <div class="form-group col-md-6 col-xl-4">
                  ...
                  <input id="alertQuantity" v-model="form.alertQuantity" type="number" min="0" max="127"

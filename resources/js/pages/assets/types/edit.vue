      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">{{ $t('assets.types.edit.form_title') }}</h3>
...
export default {
  ...
  metaInfo() {
    return { title: this.$t('assets.types.edit.page_title') }
  },
  data: () => ({
    breadcrumbsCurrent: 'assets.types.edit.breadcrumbs_current',
    breadcrumbs: [
      {
        name: 'assets.types.edit.breadcrumbs_first',
        url: 'home',
      },
      {
        name: 'assets.types.edit.breadcrumbs_second',
        url: 'assetTypes.index',
      },
      {
        name: 'assets.types.edit.breadcrumbs_active',
        url: '',
      },
    ],
    form: new Form({
    ...
    async updateCategory() {
      await this.form
        ...
        .then(() => {
          toast.fire({
            type: 'success',
            title: this.$t('assets.types.edit.success_msg'),
          })

              ...
              <div class="row">
                ...
                <div v-if="items" class="form-group col-md-6">
                  ...
                  <v-select
                    ...
                    :options="items"
                    label="name"
                    :class="{ 'is-invalid': form.errors.has('assetType') }"
                    name="assetType"
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input
                    ...
                    type="number"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('assetCost') }"
                    name="assetCost"
                    :placeholder="$t('assets.common.asset_cost_placeholder')"
              ...
              <div v-if="form.depreciation == 1" class="row">
                ...
                <div class="form-group col-md-3">
                  ...
                  <input
                    ...
                    type="number"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('salvageValue') }"
                    name="salvageValue"
                    min="0"
                    :max="form.assetCost"
                    :placeholder="$t('assets.common.salvage_value_placeholder')"
                    @change="calculateDepreciationExpense"
                    @keyup="calculateDepreciationExpense"
                  />
                ...
                <div class="form-group col-md-3">
                  ...
                  <input
                    ...
                    type="number"
                    class="form-control"
                    :class="{ 'is-invalid': form.errors.has('usefulLife') }"
                    name="usefulLife"
                    :placeholder="$t('assets.common.useful_life_placeholder')"
                    @change="calculateDepreciationExpense"
                    @keyup="calculateDepreciationExpense"
                  />
                ...
                <div class="form-group col-md-3">
                  ...
                  <input
                    ...
                    v-model="form.depreciationExpense"
                    type="text"
                    class="form-control"

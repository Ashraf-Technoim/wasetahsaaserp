              ...
              <div class="row">
                <div class="form-group col-md-6 col-xl-3">
                  ...
                  <input id="poReference" v-model="form.poReference" type="text" step="any" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('poReference') }" name="poReference" :placeholder="
                      $t('purchases.list.common.po_reference_placeholder')
                    " />
                ...
                <div class="form-group col-md-6 col-xl-3">
                  ...
                  <input id="paymentTerms" v-model="form.paymentTerms" type="text" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('paymentTerms') }" name="paymentTerms" :placeholder="
                      $t('purchases.list.common.payment_terms_placeholder')
                    " />
                ...
                <div v-if="taxes" class="form-group col-md-6 col-xl-3">
                  ...
                  <v-select v-model="form.orderTax" :options="taxes" label="code"
                    :class="{ 'is-invalid': form.errors.has('orderTax') }" name="orderTax" :placeholder="
                      $t('purchases.list.common.purchase_tax_placeholder')
                    " @input="updateTax" />
              ...
              <div v-if="form.selectedProducts && form.selectedProducts.length > 0" class="row">
                <div class="form-group col-md-6 col-xl-3">
                  ...
                  <input id="discount" v-model="form.discount" type="number" step="any" min="1" :max="form.subTotal"
                    ...
                    :placeholder="
                      $t('purchases.list.common.discount_placeholder')
                ...
                <div class="form-group col-md-6 col-xl-3">
                  ...
                  <input id="transportCost" v-model="form.transportCost" type="number" step="any" min="0"
                    ...
                    name="transportCost" :placeholder="
                      $t('purchases.list.common.transport_cost_placeholder')
                    " @change="calculateSum" @keyup="calculateSum" />
              ...
              ">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input id="totalPaid" v-model="form.totalPaid" type="number" step="any" class="form-control"
                    :class="{ 'is-invalid': form.errors.has('totalPaid') }" name="totalPaid" min="1"
                    :max="form.netTotal" :placeholder="$t('common.amount_placeholder')" />
